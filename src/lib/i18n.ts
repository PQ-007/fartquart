...
const dict = {
  ...
  mn: {
    ...
    graph: {
      ...
      creation: "бүтээл",
      showTags: "тагууд",
      searchFiles: "Файл хайх…",
      filters: "Шүүлтүүр",
      orphans: "Тусгаарлагдсан",
      display: "Харагдац",
      arrows: "Сум",
      textFade: "Бичвэрийн босго",
      nodeSize: "Зангилааны хэмжээ",
      linkThickness: "Холбоосын зузаан",
      animate: "Тоглуулах",
      pause: "Түр зогсоох",
      forces: "Хүчүүд",
      centerForce: "Төвлөрөх хүч",
      repelForce: "Түлхэх хүч",
      linkForce: "Холбох хүч",
      linkDistance: "Холбоосын зай",
      reset: "Дахин тохируулах",
      closePanel: "Шүүлтүүр хаах",
      openPanel: "Шүүлтүүр нээх",
      vault: "Файлын мод",
    },
