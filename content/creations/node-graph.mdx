...
mainVideo: 'lab/node-graph/main-video'
...
```bash
npx create-vite@latest node-graph
```
...
```bash
npm install @pixi/events @pixi/react @pixi/react-animated matter-js pixi.js atom.io
```

You'll also want to install these packages as dev dependencies:

```bash
npm install @types/matter-js sass --save-dev
```
