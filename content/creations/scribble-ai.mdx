...
draft: false
mainVideo: 'projects/scribble-ai/Timeline_2_nzrcwr'
...
<CloudImage path="projects/scribble-ai/windows1_oiw7yl.png" subText={`An example of different windows.`} width={1117} height={760} />
...
<CloudImage path="projects/scribble-ai/generator_wwurdm.png" subText={`A generator window.`} width={1117} height={760} />
...
<CloudImage path="projects/scribble-ai/generation_z3ckqa.png" subText={`A generation window.`} width={1115} height={787} />
...
<CloudImage path="projects/scribble-ai/settings_m848xm.png" subText={`A settings window.`} width={800} height={547} />
...
<CloudImage path="projects/scribble-ai/connections.png" subText={`An example of multiple connections`} width={1640} height={1314} />
