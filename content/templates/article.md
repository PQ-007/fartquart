---
title:                                    # Headline — shown as the page title and on cards
date: 2026-01-01                          # YYYY-MM-DD — controls ordering (newest first)
label: article                            # Keep as "article" → appears on /blog
description:                              # 1–2 sentences — shown on cards, search, and link previews
...
> Write the article here. Use `## Section` headings — they build the
> table-of-contents sidebar. Delete this note and the line below.
